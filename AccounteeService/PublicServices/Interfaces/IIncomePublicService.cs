...
{
    Task<PagedList<IncomeDto>> GetIncomes(string? searchValue, OrderFilter orderFilter, PageFilter pageFilter, CancellationToken cancellationToken);
    Task<PagedList<IncomeDto>> GetUserIncomes(int? userId, string? searchValue, OrderFilter orderFilter, PageFilter pageFilter, CancellationToken cancellationToken);
