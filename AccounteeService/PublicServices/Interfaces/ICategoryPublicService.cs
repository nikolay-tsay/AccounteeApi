...
{
    Task<PagedList<CategoryDto>> GetCategories(string? searchValue, OrderFilter orderFilter, PageFilter pageFilter, CategoryTargets target, CancellationToken cancellationToken);
